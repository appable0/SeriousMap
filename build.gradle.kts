...
loom {
    launchConfigs {
        "client" {
            ...
            arg("--mixin", "mixins.seriousmap.json")
        }
    }
    forge {
        pack200Provider.set(dev.architectury.pack200.java.Pack200Adapter())
        mixinConfig("mixins.seriousmap.json")
    }
    mixin {
        defaultRefmapName.set("mixins.seriousmap.refmap.json")
    }
}
...
tasks.withType(Jar::class) {
    manifest.attributes.run {
        ...
        this["MixinConfigs"] = "mixins.seriousmap.json"
